    ...
    for (l_frame = batch_meta->frame_meta_list; l_frame != NULL;
      l_frame = l_frame->next) {
        ...
        for (l_obj = frame_meta->obj_meta_list; l_obj != NULL;
          ...
          NvOSD_RectParams NvBbox_Coords = obj_meta->rect_params; 
          g_print("Coordinates [%f, %f, %f, %f]  for object id %ld \n", NvBbox_Coords.left, (NvBbox_Coords.left + NvBbox_Coords.width), NvBbox_Coords.top, (NvBbox_Coords.top + NvBbox_Coords.height), obj_meta->object_id);
          }
